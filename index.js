require([
  ...
  //This is the popup for the hospital locations
  var popupHosp = {
    title: "{Hospital}",
    content:
      "<b>City:</b> {City_Town}<br><b>Address:</b>  {Address_1}<br><b>Trauma Level:</b> {Trauma_Level}"
  };

  var hosp_Info = new FeatureLayer({
    url:
      "https://services.arcgis.com/o6oETlrWetREI1A2/arcgis/rest/services/Hospital_LL/FeatureServer",

    outFields: ["City_Town", "Address_1", "Trauma_Level"],
    popupTemplate: popupHosp
  });
  //This adds the popup to template
  map.add(hosp_Info);
  ...
  function setUpAppUI() {
    ...
    view.when(function() {
      ...
      //add search bar to the top-right
      ...
      // Display the Legend in side panel two
      ...
      //create a way to toggle between the two maps
  ...
  function setUpSketch() {
    ...
    // Listen to SketchViewModel's update event so that hospital info chart is updated
